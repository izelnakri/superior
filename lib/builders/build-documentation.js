...
import convertTSModuletoAMD from '../transpilers/convert-es-module-to-amd';
...
function convertFile(code, applicationName, fileAbsolutePath) {
  ...
  } else if (fileAbsolutePath.endsWith('.ts')) {
    return convertTSModuletoAMD(code, {
      moduleName: `${applicationName}${moduleName.slice(0, -3)}`
    });
  }
